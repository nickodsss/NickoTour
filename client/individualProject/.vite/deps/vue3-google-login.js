...
var I = (e, t, i, o) => {
  ...
  i.popupType && !o && console.warn("Option 'popupType' is ignored since a slot which act as a custom login button was not found!!!"), y(() => {
    ((e2, t2, i2, o2, n) => {
      if (n) {
    ...
    })(e, t, i.buttonConfig, o, i.error), i.prompt && C({ clientId: i.clientId, callback: i.callback, error: i.error, autoLogin: i.autoLogin });
  });
};
